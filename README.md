...
We will take a look at data on SATs across public schools in New York City in this *[notebook](https://github.com/vchow6/Project-Exploring-NYC-Public-School-Test-Result-Scores/blob/main/NYC_test_scores.ipynb)*. Our database contains a single table:
